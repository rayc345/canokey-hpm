...
#define USB_VID 0xC95C
#define USB_PID 0x347D
...
uint8_t desc_fs_configuration[] =
    {
        ...
        TUD_HID_INOUT_DESCRIPTOR(HID_ITF_CTAP, 0, HID_ITF_PROTOCOL_NONE, sizeof(desc_ctaphid_report), CFG_TUD_EPNUM_CTAPHID, 0x80 | CFG_TUD_EPNUM_CTAPHID, 64, 1)};
...
uint8_t desc_hs_configuration[] =
    {
        ...
        /* Interface number, string index, protocol, report descriptor len, EP In & Out address, size & polling interval */
        TUD_HID_INOUT_DESCRIPTOR(HID_ITF_CTAP, 0, HID_ITF_PROTOCOL_NONE, sizeof(desc_ctaphid_report), CFG_TUD_EPNUM_CTAPHID, 0x80 | CFG_TUD_EPNUM_CTAPHID, 512, 4)};
#endif
